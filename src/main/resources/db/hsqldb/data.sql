...
INSERT INTO cards(cardimage,cardtype,position,title,description,effect,initial) VALUES ('resources/cards/Muster and Army.png','ESPECIAL',null,'Muster an Army','When resolving actions this round, treat all defensive locations as if they are occupied.','muster',FALSE);
...
INSERT INTO cards(cardimage,cardtype,position,title,description,effect,initial) VALUES ('resources/cards/apprentice.png','ESPECIAL',null,'Apprentice','Place one worker on a location occupied by the other player.','appretince',FALSE);
